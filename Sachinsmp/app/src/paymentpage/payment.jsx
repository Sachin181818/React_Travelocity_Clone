  ...
  return (
    <div className={styles.payment}>
     ...
     <span className={styles.subhead}>
             ...
             {/* main div for left and right  */}
       <div className={styles.sidesDecison}>
                        ...
                        <div className={styles.third_div}>     
                            ...
                            <div className={styles.para1}>
                                        ...
                                        <div>
                                            ...
                                            <div >
                                                <a style={{fontSize:"12px",color: "#00e"}} href="" target="_blank">View insurance details and disclosures 
                                                </a>
                                            </div>
          ...
          <div className={styles.rightSide}>
                ...
                <p className={styles.rightSide1} style={{backgroundImage:` url("https://images.trvl-media.com/hotels/1000000/530000/526400/526339/d715ecf3_l.jpg")`}}><span>Savoy - IHCL SeleQtions</span></p>
                ...
                <div>
                        <div>
                              ...
                              <span>(77 reviews)</span>
                                ...
                                <div >
                                  <span>Guests rated this property 4.3/5 for cleanliness</span>
                                </div>
                        </div>
                        <div >
                            <span>1 Room:</span>
                            <span>Superior Room, 1 Queen Bed</span>
                        </div>
                        {/* <div>
                        <div></div>
                        </div> */}
                        ...
                        <div >
                            <ul >
                               <li >
                        <a>     Non-refundable <span ></span></a><div ><span>If you change or cancel your booking you will not get a refund or credit to use for a future stay. This policy will apply regardless of COVID-19, subject to any local consumer laws.</span></div>
                        </li>
                            </ul>
                        </div>
                        ...
                        <div>
                                <span >Check-in:</span>
                                <span >Thu, May 19</span>
                        </div>
                        <div >
                            <span >Check-out:</span>
                            <span >Fri, May 20</span>
                        </div>
